  ...
  <section class="container">
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="R & D.jpeg " class="card-img-top" alt="Image">
          <div class="card-body">
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="QUALITY.jpeg" class="card-img-top" alt="Image">
          <div class="card-body">
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="PATIENT.jpeg" class="card-img-top" alt="Image">
          <div class="card-body">
...
<body>
  ...
  <section class="container py-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
      <div class="col">
        <div class="card">
          <img src="P1.jpeg" class="card-img-top" alt="Product Image">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card">
          <img src="P2.jpeg" class="card-img-top" alt="Product Image">
          <div class="card-body">
  ...
  <section class="container py-5">
    ...
    <div class="row">
      <div class="col-md-3 mb-2">
        <div class="card">
          <img src="pencil 2.jpeg" class="card-img-top" alt="News Image">
          <div class="card-body">
      ...
      <div class="col-md-3 mb-2">
        <div class="card">
          <img src="pencil.jpeg" class="card-img-top" alt="News Image">
          <div class="card-body">
